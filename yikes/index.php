...
<head>
  ...
  <title>Urban Sound Prediction</title>
  <meta name="description" content="Hello! You have found a somewhat interesting project lol">
  <meta http-equiv="" content="">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="assets/css/styles.min.css?h=31d9b7344ae9f854146b03ae1b8c38f3">
</head>
...
<body>
  <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
          ...
          </svg></span><span>Urban Sound Classification</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-5"><span class="visually-hidden">Toggle
  ...
  <main>
    <section>
      <div class="container">
        ...
        <h5 style="text-align: center;">Prediction:</h5><button class="btn btn-primary btn-center" type="button" onclick="predict(model)">Predict</button>
        ...
        <form id="upload-form" action="getdata" method="POST" enctype="multipart/form-data">
          ...
          <input class="btn btn-primary btn-form " type="submit" name="submit">
        </form>
      </div>
    </section>
  </main>
  ...
  <script src="assets/js/script.min.js?h=fe536714d7e186599b8598ae299bbb04"></script>
</body>
